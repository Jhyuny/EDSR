...
class SRData(data.Dataset):
    def __init__(self, args, name='', train=True, benchmark=False):
        ...
        if args.ext.find('img') >= 0 or benchmark:
            ...
            for h in list_hr:
                ...
                b = b.replace(self.ext[0], '.pt') #.png > .pt로 변경
        ...
        if train:#True이므로 실행
            n_patches = args.batch_size * args.test_every #batch_size = 16, test_every = 1000
    ...
    def _scan(self):
        ...
        return names_hr, names_lr #lr,hr image의 path를 list에 정리
